export const DINAMICAS = [
  { id: "foto", name: "Foto del celular", emoji: "📸", desc: "Elegi una foto de tu celu que sientas que es importante para vos y comparti el porque.", duration: 5 },
  { id: "amistad", name: "Lo valoro en alguien", emoji: "🤝", desc: "Decí qué valorás más en una amistad o en un compañero.", duration: 6 },
  { id: "mapa", name: "mapa del año", emoji: "🗺️", desc: "Comparti con tu grupo como venis transitando este 2026 hasta el momento.", duration: 5 },
  ...
  { id: "pregunta", name: "Pregunta misteriosa", emoji: "❓", desc: "Pone una pregunta en un papel. una vez que este con tu grupo mezclen todas y saquen una al azar.", duration: 5 },
  ...
  { id: "orgullo",      name: "Algo de lo que me siento orgulloso", emoji: "🏆", desc: "Compartí algo que hayas logrado y que valorés mucho.", duration: 6 },
