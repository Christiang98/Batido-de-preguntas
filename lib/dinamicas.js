export const DINAMICAS = [
  ...
  { id: "arbol", name: "El árbol de mis logros", emoji: "🌳", desc: "Dibujá un árbol simple. En las raíces escribí tus fortalezas, y en los frutos, tus mayores logros.", duration: 10 },
  ...
  { id: "lista", name: "Mi lista", emoji: "🌟", desc: "Escribí en el papel del 1 al 5 cuales son hoy tus mayores prioridades y comenta el porqué de ese orden.", duration: 6 },
  ...
  { id: "regalo", name: "Regalo invisible", emoji: "🎁", desc: "Si pudieras regalarle una habilidad o virtud a la persona de tu derecha, ¿cuál sería?", duration: 5 },
